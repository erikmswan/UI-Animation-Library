...
/***/ function(module, exports, __webpack_require__) {
	...
	var ANIM = function () {
	    ...
	    function setTiming(arg) {
	        ...
	        (0, _jquery2.default)('.' + opt.parent).each(function (el) {
	            if ((!arg || !arg.delay) && getTimingDelay((0, _jquery2.default)(_this)) !== null) {
	                opt.delay = getTimingDelay((0, _jquery2.default)(_this));
	            } else if (arg && arg.delay) {
	                opt.delay = arg.delay;
	            }

	            if ((!arg || !arg.increment) && getTimingIncrement((0, _jquery2.default)(_this)) !== null) {
	                opt.increment = getTimingIncrement((0, _jquery2.default)(_this));
	            } else if (arg && arg.increment) {
	                opt.increment = arg.increment;
	            }

	            setChildTiming((0, _jquery2.default)(_this).find(opt.child), opt.delay, opt.increment, opt.type);
	        });
	    }

	    // Utility function to get the timing delay from the 'timing-delay' attribute
	    function getTimingDelay(el) {
	        var timingDelayAttr = parseInt((0, _jquery2.default)(el).attr('timing-delay'));
	        var timingDelay = isNaN(timingDelayAttr) ? null : timingDelayAttr;
	        return timingDelay;
	    }

	    // Utility function to get the timing increment from the 'timing-increment' attribute
	    function getTimingIncrement(el) {
	        var timingIncrementAttr = parseInt((0, _jquery2.default)(el).attr('timing-increment'));
	        var timingIncrement = isNaN(timingIncrementAttr) ? null : timingIncrementAttr;
	    ...
	    function setChildTiming(el, start, increment, type) {
	        ...
	        var realIncrement = increment === undefined ? 0 : increment;

	        (0, _jquery2.default)(el).each(function () {
	            if (type === 'transition') (0, _jquery2.default)(this).css('transition-delay', timingDelay + 'ms');
	            if (type === 'animation') (0, _jquery2.default)(this).css('animation-delay', timingDelay + 'ms');
	    ...
	    function letterFadeIn(selector, fadeInClass, start, increment) {
	        ...
	        (0, _jquery2.default)(selector).each(function () {
	            var split = (0, _jquery2.default)(this).html().match(/[a-zA-Z\d&;<\/="\->\s\n]/g);
	            var htmlEntity = false;
	            var htmlEntityContainer = void 0;
	            ...
	            (0, _jquery2.default)(this).html(joinedMappedSplit);
	        });

	        var timingDelay = start ? start : getTimingDelay(selector);
	        var timingIncrement = increment ? increment : getTimingIncrement(selector);
